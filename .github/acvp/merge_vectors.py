...
simplified test vector files for rust-qrllib ML-DSA-87 testing.
...
def merge_siggen(prompt_path, results_path, param_set):
    ...
    for tg in prompt["testGroups"]:
        ...
        # - deterministic: vector uses deterministic signing (rnd=zeros)
        # - external: tests the full Sign() API including context encoding
        # - pure: rust-qrllib implements pure ML-DSA, not pre-hash variant
