...
This directory contains tooling for testing `rust-qrllib`'s ML-DSA-87 implementation against official NIST ACVP (Automated Cryptographic Validation Protocol) test vectors.
...
Only deterministic, external-interface, pure (non-preHash) signature vectors are tested.
